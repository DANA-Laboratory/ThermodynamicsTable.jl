...
type PropertyPackage
  function PropertyPackage(constantstrings,t1,constantfloats,t2,tempreturedependents,t3,pressuredependents,t4,propertytable,convertions,tableaddreses,datafilename)
    new(
